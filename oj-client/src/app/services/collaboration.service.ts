...
export class CollaborationService {
  ...
  init(editor: any, sessionId: string): void {
      ...
      //window.location.origin = http://localhost:3000 (output for below)
      console.log('window.location.origin = '+window.location.origin);
      //listen change from other client then apply it in editor
      ...
      //listen cursorMove from other client then apply it in editor
